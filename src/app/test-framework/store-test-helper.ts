      ...
      application: {
        ...
        '8b501d9e-4e27-4d7d-bdf5-8b20975137c0': {
          entity: {
            ...
            environment_json: {
              STRATOS_PROJECT: '{"deploySource":{"type":"github","timestamp":1506186204,"project":"nwmac/cf-demo-app","branch":"master","url":"https://github.com/nwmac/cf-demo-app","commit":"9249fe2f739b93770e0d85ce5578df0cd22355b8\\n"}}'
            },
            memory: 64,
            instances: 1,
            disk_quota: 16,
            ...
            service_bindings: [
              {
                ...
                entity: {
                  ...
                  credentials: {
                    ...
                    uri: 'mysql://Ylgy7uLdvkyzTMKe:wScrF2EvIdScRHgW@mysql-proxy.cf.svc.cluster.local:3306/cf_bfae68fb_b981_4ee2_88ec_70176f7a7c93?reconnect=true',
        ...
        'b87f92ee-bcaa-4430-96d5-ef5b7a80214f': {
          entity: {
            ...
            environment_json: {
              STRATOS_PROJECT: '{"url":"https://github.com/troytop/presentation-template","commit":"bcb2cd228ed26fa72f5e029f6979f4e0c971de29\\n","branch":"cap-roadmap","timestamp":1505336909}'
            },
            memory: 64,
            instances: 1,
            disk_quota: 256,
      ...
      entities: [
        {
          ...
          api_endpoint: {
            ...
            Opaque: '',
            User: null,
            Host: 'api.10.84.93.99.nip.io:8443',
            Path: '',
            RawPath: '',
            ForceQuery: false,
            RawQuery: '',
          ...
          authorization_endpoint: 'https://cf.uaa.10.84.93.99.nip.io:2793',
          token_endpoint: 'https://cf.uaa.10.84.93.99.nip.io:2793',
          doppler_logging_endpoint: 'wss://doppler.10.84.93.99.nip.io:4443',
        ...
        },
        {
          ...
          api_endpoint: {
            ...
            Opaque: '',
            User: null,
            Host: 'api.10.84.93.96.nip.io:8443',
            Path: '',
            RawPath: '',
            ForceQuery: false,
            RawQuery: '',
          ...
          authorization_endpoint: 'https://cf.uaa.10.84.93.96.nip.io:2793',
          token_endpoint: 'https://cf.uaa.10.84.93.96.nip.io:2793',
          doppler_logging_endpoint: 'wss://doppler.10.84.93.96.nip.io:4443',
          skip_ssl_validation: true,
          registered: true
        },
        {
          ...
          authorization_endpoint: 'https://cf.uaa.capbristol.com:443',
          token_endpoint: 'https://cf.uaa.capbristol.com:443',
          doppler_logging_endpoint: 'wss://doppler.capbristol.com:443',
          skip_ssl_validation: true,
          registered: true
        },
        {
